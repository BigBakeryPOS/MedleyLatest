        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //    string Unit =gvPo.Rows[i].Cells[7].Text;
                ...
                for (int vLoop = 0; vLoop < gvPo.Rows.Count; vLoop++)
                {
                    ...
                    int isuccess1 = dbObj.InsertTransGPN(GPNID, Convert.ToInt32(txtProductId.Text), 0, Convert.ToInt32(txtremarks.Text), 0, 0, 0,txtbatchnumber.Text, txtUnitname.Text, txtPalletsrefno.Text);
