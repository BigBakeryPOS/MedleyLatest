                ...
                if (iGRId != 0)
                {
                    ...
                    else
                    {
                        ...
                        if (dsgr.Tables[0].Rows.Count > 0)
                        {
                            ...
                            int remainqty = Ordqty - Rcdqty;
                            lblrcdqty.Text = "Remaining Qty";
                            txtRecdQty.Text = remainqty.ToString();
                            lblremqty.Text = "Received Qty";
                            txtRemqty.Text = dsgr.Tables[0].Rows[0]["Qty"].ToString();
                            //txtpalletsrefno.Text = ((DateTime)dsgr.Tables[0].Rows[0][""]).ToString("yyyy-MM-dd");
                            txtExpDate.Text = ((DateTime)dsgr.Tables[0].Rows[0]["ExpiryDate"]).ToString("yyyy-MM-dd");
                            //txtPallets.Text = dsgr.Tables[0].Rows[0]["PalletsQty"].ToString();
                            ddlbatchstatus.SelectedItem.Text = dsgr.Tables[0].Rows[0]["BatchStatus"].ToString();

                            //DataSet dsunitvalue= dbObj.select_Editunitvalue(iGRId,Convert.ToInt32(ddlProductid.Text));
                           // if (dsunitvalue.Tables[0].Rows.Count > 0)
                           // {
                                //string palletsno = dsunitvalue.Tables[0].Rows[0]["rows"].ToString();
                                ...
                                if (Convert.ToInt32(txtRecdQty.Text) == totalqty)
                                {
                                    for (int i = 0; i < Convert.ToInt32(txtPallets.Text); i++)
                                    {
                                        ...
                                        else if (lbl10.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl10.Text, Convert.ToInt32(txt10.Text), txtpr10.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl10.Text, Convert.ToInt32(txt10.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr10.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl10.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt10.Text), ddlbatchstatus.SelectedItem.Text, txtpr10.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl10.Visible = false; txt10.Visible = false; txtpr10.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl11.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl11.Text, Convert.ToInt32(txt11.Text), txtpr11.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl11.Text, Convert.ToInt32(txt11.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr11.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl11.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt11.Text), ddlbatchstatus.SelectedItem.Text, txtpr11.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl10.Visible = false; txt11.Visible = false; txtpr11.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl12.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl12.Text, Convert.ToInt32(txt12.Text), txtpr12.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl12.Text, Convert.ToInt32(txt12.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr12.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                        ...
                                        else if (lbl13.Visible == true)
                                        {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl13.Text, Convert.ToInt32(txt13.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr13.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl13.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt13.Text), ddlbatchstatus.SelectedItem.Text, txtpr13.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl13.Visible = false; txt13.Visible = false; txtpr13.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl14.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl14.Text, Convert.ToInt32(txt14.Text), txtpr14.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl14.Text, Convert.ToInt32(txt14.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr14.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl14.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt14.Text), ddlbatchstatus.SelectedItem.Text, txtpr14.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl14.Visible = false; txt14.Visible = false; txtpr14.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl15.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl15.Text, Convert.ToInt32(txt15.Text), txtpr15.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl15.Text, Convert.ToInt32(txt15.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr15.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl15.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt5.Text), ddlbatchstatus.SelectedItem.Text, txtpr15.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl15.Visible = false; txt15.Visible = false; txtpr15.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl16.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl16.Text, Convert.ToInt32(txt16.Text), txtpr16.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl16.Text, Convert.ToInt32(txt16.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr16.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl16.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt6.Text), ddlbatchstatus.SelectedItem.Text, txtpr16.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl16.Visible = false; txt16.Visible = false; txtpr16.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl17.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl17.Text, Convert.ToInt32(txt17.Text), txtpr17.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl17.Text, Convert.ToInt32(txt17.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr17.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl17.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt17.Text), ddlbatchstatus.SelectedItem.Text, txtpr17.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl17.Visible = false; txt17.Visible = false; txtpr17.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl18.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl18.Text, Convert.ToInt32(txt18.Text), txtpr18.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl18.Text, Convert.ToInt32(txt18.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr18.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl18.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt18.Text), ddlbatchstatus.SelectedItem.Text, txtpr18.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl18.Visible = false; txt18.Visible = false; txtpr18.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGR(Convert.ToInt32(txtGRNnumber.Text), lbl19.Text, Convert.ToInt32(txt19.Text), txtpr19.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablity(0, lbl19.Text, Convert.ToInt32(txt19.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr19.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl19.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt19.Text), ddlbatchstatus.SelectedItem.Text, txtpr19.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl19.Visible = false; txt19.Visible = false; txtpr19.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                    }
                    ...
                    else if (btnSubmit.Text == "Update")
                    {
                        ...
                        else
                        {
...

                            {
                                ...
                                int qty18 = Convert.ToInt32(txt18.Text); int qty19 = Convert.ToInt32(txt19.Text);
                                int totalqty = qty0 + qty1 + qty2 + qty3 + qty4 + qty5 + qty6 + qty7 + qty8 + qty9 + qty10 + qty11 + qty12 + qty13 + qty14 + qty15 + qty16 + qty17 + qty18 + qty19;
                                if (Convert.ToInt32(txtOrderqty.Text) == totalqty)
                                {
                                    for (int i = 0; i < Convert.ToInt32(txtPallets.Text); i++)
                                    {
                                        if (lbl0.Visible == true)
                                        ...
                                        else if (lbl17.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGRedit(Convert.ToInt32(txtGRNnumber.Text), lbl17.Text, Convert.ToInt32(txt17.Text), txtpr17.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablityedit(0, lbl17.Text, Convert.ToInt32(txt17.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr17.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl17.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt17.Text), ddlbatchstatus.SelectedItem.Text, txtpr17.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl17.Visible = false; txt17.Visible = false; txtpr17.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                        else if (lbl18.Visible == true)
                                        {
                                            ...
                                            int iSuccess = dbObj.InsertTransGRedit(Convert.ToInt32(txtGRNnumber.Text), lbl18.Text, Convert.ToInt32(txt18.Text), txtpr18.Text, ddlbatchstatus.SelectedItem.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int Id = 0;
                                            DataSet dsGR = dbObj.GetMax_TransGR();
                                            if (dsGR.Tables[0].Rows.Count > 0)
                                            {
                                            ...
                                            int iSuccess1 = dbObj.InsertTransetraceablityedit(0, lbl18.Text, Convert.ToInt32(txt18.Text), ddlStatus.SelectedItem.Text, Convert.ToInt32(txtGRNnumber.Text), TraceId, txtpr18.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            int iUpdate = dbObj.UpdateUnitQty(Id, lbl18.Text, Convert.ToInt32(ddlProductid.SelectedValue), txtBatch.Text, txtExpDate.Text, Convert.ToInt32(txt18.Text), ddlbatchstatus.SelectedItem.Text, txtpr18.Text, Convert.ToInt32(ddlPOnumber.SelectedValue));
                                            lbl18.Visible = false; txt18.Visible = false; txtpr18.Visible = false; btnCalSubmit.Visible = false;
                                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Data Stored Successfully');", true);
                                        }
                                    ...
                                    {
                                        int iSuccess3 = dbObj.UpdateUnitQtyupdate1(Convert.ToInt32(txtGRNnumber.Text), ddlStatus.Text);
                                        int iSuccess = dbObj.UpdateGRforreject(Convert.ToInt32(txtGRNnumber.Text), Convert.ToInt32(ddlProductid.SelectedValue));
                                        int iSuccess1 = dbObj.UpdatePO_GoodReceiptforreject(0, Convert.ToInt32(ddlProductid.SelectedValue), Convert.ToInt32(ddlPOnumber.SelectedValue));
                                        int iSuccess2 = dbObj.UpdatetblTrancetraceablityforrej(Convert.ToInt32(txtGRNnumber.Text), ddlStatus.SelectedItem.Text);
                                    }
                                    else
                                    {
